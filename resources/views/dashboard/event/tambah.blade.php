                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ Yeah::validForm($errors->first('kode_scanner_events')) }}" id="kode_scanner_events" type="text" name="kode_scanner_events" value="{{Request::old('kode_scanner_events')}}">
