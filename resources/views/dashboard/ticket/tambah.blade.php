                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ Yeah::validForm($errors->first('deskripsi_tickets')) }}" id="editor2" name="deskripsi_tickets" rows="5">{{Request::old('deskripsi_tickets')}}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ Yeah::validForm($errors->first('disclaimer_tickets')) }}" id="editor1" name="disclaimer_tickets" rows="5">{{Request::old('disclaimer_tickets')}}</textarea>
