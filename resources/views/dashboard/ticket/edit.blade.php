                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control {{ Yeah::validForm($errors->first('informasi_registrasi_tickets')) }}" id="informasi_registrasi_tickets" name="informasi_registrasi_tickets" rows="3">{{Request::old('informasi_registrasi_tickets') == '' ? $edit_tickets->informasi_registrasi_tickets : Request::old('informasi_registrasi_tickets')}}</textarea>
