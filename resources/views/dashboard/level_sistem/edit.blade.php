				...
				<form class="form-horizontal m-t-40" action="{{ URL('dashboard/level_sistem/prosesedit/'.$edit_level_sistems->id_level_sistems) }}" method="POST">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input class="form-control {{ Yeah::validForm($errors->first('nama_level_sistems')) }}" id="nama_level_sistems" type="text" name="nama_level_sistems" value="{{Request::old('nama_level_sistems') == '' ? $edit_level_sistems->nama_level_sistems : Request::old('nama_level_sistems')}}">
						...
						<table class="table table-responsive-sm table-bordered table-striped table-sm">
							...
							<tbody>
								...
								@php($get_sub_menus = \App\Models\Master_menu::where('sub_menus_id',$id_menus)
																		->orderBy('order_menus')
																		->get())
